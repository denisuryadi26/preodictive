...
<section class="about_area p_60">
    <div class="container">
        <div class="main_title">
            <h2 style="font-size: 33px !important;">Tentang Preodictive - Web Edukasi Open Source</h2>
            <p>Preodictive adalah web open source yang dibuat oleh <a
