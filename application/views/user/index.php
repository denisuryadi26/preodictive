...
<head>
    ...
    <title>Selamat datang - <?php
                            ...
                            echo $data['user']['nama'];
                            ?> - Preodictive Student Page</title>
    <!-- Bootstrap CSS -->
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="1400">Selamat Datang
                        di Preodictive <span style="font-size: 40px;">👋🏻
                        </span> </h1>
                    <p>Hello Students! , Ini merupakan halaman utama Preodictive ! Silahkan pilih kelas yang akan kamu
                        akses
