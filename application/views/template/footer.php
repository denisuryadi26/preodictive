    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Preodictive</a></li>
                        <li><a href="<?= base_url('welcome/materi') ?>">Materi Preodictive</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Preodictive</a></li>
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    <h6 class="footer_title">Kontak Person</h6>
                    <ul class="list">
                        <li><a href="wa.me/628551607171">Deni Suryadi</a></li>
                        <li><a href="#">Ahmad Galih P</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Preodictive</h4>
                <p>
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                Made with <span class="text-danger"> &#10084;</span> by Preodictive
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
