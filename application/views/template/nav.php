...
<head>
    ...
    <title>Preodictive Education - Bimbel Online Terbaik Untuk Anak Bangsa</title>
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="<?= base_url('assets/') ?>css/pricelist.css">

    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/assets/vendors/general/fontawesome-free/css/all.min.css">
        ...
        <div class="top_menu row m0">
            <div class="container">
                ...
                <div class="float-right">
                    <a class="dn_btn" href="wa.me/628551607171">0851607171</a>
                    <a class="dn_btn" href="mailto:info@preodictive.com">info@preodictive.com</a>
                </div>
            </div>
        </div>
